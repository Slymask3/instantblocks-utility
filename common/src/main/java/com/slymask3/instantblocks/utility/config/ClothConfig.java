...
import com.slymask3.instantblocks.utility.config.entry.ColorSet;
import com.slymask3.instantblocks.utility.config.entry.HugeTree;
...
@Config(name = Common.MOD_BASE + "/" + Common.MOD_ADDON)
